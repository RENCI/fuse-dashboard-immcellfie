    ...
    <Card>
      ...
      <Body>        
        ...
        { subgroup2 &&
          <Row>
            <Col>
              <div className='mt-1 text-muted small'>A fold change greater than 1 indicates a higher score for <strong>{ subgroup1.name }</strong> compared to <strong>{ subgroup2.name }</strong>, and less than 1 a lower score for <strong>{ subgroup1.name }</strong> compared to <strong>{ subgroup2.name }</strong>.</div>
            </Col>
          </Row>
        }
      </Body>
